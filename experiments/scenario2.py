"""
Scenario 2 — Best access pattern, equal weights.
Expected: SC > SA > SD > SB
Run: python experiments/scenario2.py
"""
import sys, os
...
def main():
    ...
    w  = SCENARIO_WEIGHTS[2]
    sc = ScenarioConfig(2, w["path"], w["subpath"], w["indpath"],
                        w["query_weights"], use_reqcolls_only=False)

    print("\n" + "="*62)
    print("  SCENARIO 2 — Best Access Pattern (equal weights)")
    print("="*62)
